...
#set up four rooms enviroment
    def __init__(self, scenario: str, stochastic: bool = True, learning_rate: float = 0.1, discount_factor: float = 0.9, epsilon: float = 0.1):
        super().__init__(scenario, stochastic)
